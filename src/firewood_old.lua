...
function firewood:createWoodPack()
    -- TODO: sincronizza in MP, ed il filltype sarà firewood
    if g_currentMission:getIsServer() then
        ...
        if g_currentMission.controlPlayer then
            ...
            if g_currentMission.player ~= nil and g_currentMission.player.isControlled and g_currentMission.player.rootNode ~= nil and g_currentMission.player.rootNode ~= 0 then
                ...
                woodPackObject:load(realFile, x,y,z,0,0,0, nil);
...
function firewood.createWoodPallet()
    
    if g_currentMission:getIsServer() then
        -- TODO: crea pallet di legna segata, filltype firewood
    end
...
function firewood.firewoodSellTrigger(triggerId, otherActorId, onEnter, onLeave, onStay, otherShapeId)
    ...
    print("balla o pallet di firewood nel trigger!!! :)")
end
